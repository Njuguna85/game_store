defmodule Pento.Game.Point do
  # core entity of this module is to create and manage
  # a point tuple

  # point constructor
  # if bad data is passed ie not integer, we just let it crash
  def new(x, y) when is_integer(x) and is_integer(y), do: {x, y}

  # move the point up and down
  def move({x, y}, {change_x, change_y}) do
    {x + change_x, y + change_y}
  end

  # flip the point over a diagonal line that
  # runs from the upper left to lower right
