defmodule PentoWeb.SurveyResultsLiveTest do
  # provides access to the ExUnit testing functions
  # provides a connection to the applications test database
  ...
  # A fixture is data we prepare before testing
  ...
  # a describe function groups together a block of tests
  # Before each test, ExUnit wil run setup callbacks
  describe "Socket state" do
    # named step functions
    # a named step function returns a map of data to merge into the context
    setup [
      :create_user,
      :create_product,
      :create_socket,
    ...
    test "ratings exists", %{socket: socket, product: product, user: user} do
